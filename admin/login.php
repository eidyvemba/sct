...
<head>
    ...
    <meta name="autor" content="eidyVemba">
    <meta name="descricao" content="empresa">
    <meta name="palavra-chave" content="tecnologias,serviços,desenvolvimento">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Perdeu a password?</button>
                    ...
                    <div class="row m-t-20">
                        <form class="col-12" action="index.php">
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success" href="#" id="to-login" name="action">Voltar Login</a>
